    ...
    return(
        <div className="w-screen h-screen flex font-open bg-no-repeat bg-cover bg-center" style={{backgroundImage:`url('${earth}')`}}>
            ...
            <div className="w-fit h-fit backdrop-blur bg-black/30 box-border p-10 rounded-lg  m-auto ml-0 text-center flex flex-col">
                <h1 className="uppercase text-white font-bold text-2xl my-6">Signup</h1>
                <form className="flex flex-col text-left my-2">
                <input type="text" className="px-2 w-80 py-3 outline-none bg-white/40  mb-6 placeholder:text-gray-800 rounded-r border-l-4 border-green-600 text-sm" required placeholder="Username"/>
                ...
                <button type="submit" className="w-full rounded-full mt-5 text-lg bg-green-600 text-white py-2 uppercase tracking-wider font-bold">Submit</button>
                </form>
